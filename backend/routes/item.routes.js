...
import { addItem, deleteItem, editItem, getItemByCity, getItemById, getItemsByShop, rating, searchItems, getAllItems } from "../controllers/item.controllers.js"
...
itemRouter.get("/:shopId", getItemsByShop)
